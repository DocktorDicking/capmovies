...
/*
Might be implementing a button to change the default UI behavior to this one. Just to display the difference
between {if} and a separate custom component.
 */
function MovieDetailsInlineIf() {
